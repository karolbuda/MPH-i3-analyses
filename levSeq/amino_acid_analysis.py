...
def main():
    ...
    with open(AA_MUTATIONS_CSV, 'w', newline='') as csvfile:
        fieldnames = ['Well', 'ReadCount', 'ORF_DNA', 'ConsensusProtein', 'AAMutations', 'NumAAMutations', 'MixedBase']
    ...
    wells_with_mixed_base = sum(1 for r in results if r['MixedBase'] == True or r['MixedBase'] == 'True')
    ...
    print(f"Wells with mixed bases: {wells_with_mixed_base}")
